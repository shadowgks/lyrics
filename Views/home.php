...
<body>
    ...
    <section class="bg-white dark:bg-gray-900 pb-20">
        <div id="accordion-flush" class="max-w-screen-xl m-auto bg-white dark:bg-gray-900 px-2" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
            <div class="sm:flex items-center justify-between">
                <div class="flex-1">
                    <h1 class="mb-4 text-4xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl dark:text-white text-center sm:text-start">
                        CHARTS</h1>
                ...
                <form class="flex-1">
                    <div class="flex">
                        ...
                        <div class="relative w-full">
                            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-l-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-orange-500" placeholder="Search Songs ..." required>
                            <button type="submit" class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-orange-500 rounded-r-lg border border-orange-500 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-orange-500 dark:bg-orange-500 dark:hover:bg-orange-500 dark:focus:ring-orange-500">
